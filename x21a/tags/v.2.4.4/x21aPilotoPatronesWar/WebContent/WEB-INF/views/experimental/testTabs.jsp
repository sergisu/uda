...
<h2>Tabs Paging</h2>
		...
		<ul id="example">
			<li><a href="#tabs-1-3">Tab 1</a></li>
			<li><a href="#tabs-2-3">This is tab 2</a></li>
			<li><a href="#tabs-3-3">This is tab number 3</a></li>
			<li><a href="#tabs-4-3">Tab no 4</a></li>
			<li><a href="#tabs-5-3">And tab number 5</a></li>
			<li><a href="#tabs-6-3">Tab number 6</a></li>
			<li><a href="#tabs-7-3">And last tab number 7</a></li>
			<li><a href="#tabs-8-3">And tab number 5</a></li>
			<li><a href="#tabs-9-3">Tab number 6</a></li>
			<li><a href="#tabs-10-3">And last tab number 7</a></li>
		</ul>
